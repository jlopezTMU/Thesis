...
#> coef(dat.lm.intercept)
#(Intercept)      log(X)      log(N) 
#1.1709617   0.6490938  -0.1158259 

a <- function(X,N)
{
   return ( 1.1709617 + 0.6490938 * (log(X)) + -0.1158259 * (log(N)) )
} 

# > coef(dat.lm.slope)
# (Intercept)             X             N 
# -8.408351e-01  2.110667e-03  3.397901e-05 
